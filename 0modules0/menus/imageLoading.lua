function loadImageLoading (flashCardNum)

	--------------------------------------------------------------------------------
	imageLoadingCanvas = ui.newCanvas(1920*0.0,1080*0.0,1920*1.0,1080*1.0) --make a UI canvas

	ui.setCanvas (imageLoadingCanvas) --set the canvas in order to add elements to it
	...
	ui.setBackgroundColor ({90, 90, 10, 255},
	...
	ui.addLabel ( "Pick an image:", true )
	ui.addNewLine()
	...
	for anImg = 1, #imagesThatCanBeLoaded, 1 do
		...
		ui.addTooltip("Pick This Image")
		ui.addButton(imagesThatCanBeLoaded[anImg])
		ui.addNewLine()
