				...
				for theElement = 1, #popupTable.elements, 1 do
					if disabledTextSkipped == false then
						...
						yCursor <= popupTable.y+popupTable.height*(theElement-2)+popupTable.height then
							setColorOld(popupTable.color.selected)
								popupTable.changedTable[popupTable.changedVar] = popupTable.elements[theElement]
								popupTable.shown = false
								save()
						end
			...
			if popupTable.upsideDown == false then
				for theElement = 1, #popupTable.elements, 1 do
					if disabledTextSkipped == false then
						...
						setColorOld(popupTable.color.line)
						love.graphics.rectangle('line', popupTable.x, popupTable.y+popupTable.height*(theElement-2), popupTable.width, popupTable.height)						setColorOld(popupTable.color.text)
						love.graphics.print(popupTable.elements[theElement], popupTable.x+5,
				...
				for theElement = 1, #popupTable.elements, 1 do
					if disabledTextSkipped == false then
						if popupTable.disabledText ~= popupTable.elements[theElement] then
							...
							setColorOld(popupTable.color.line)
							love.graphics.rectangle('line', popupTable.x, popupTable.y-(popupTable.initialButtonHeight+popupTable.height*(theElement)), popupTable.width, popupTable.height)							setColorOld(popupTable.color.text)
							love.graphics.print(popupTable.elements[theElement], popupTable.x+5,
						...
						setColorOld(popupTable.color.line)
						love.graphics.rectangle('line', popupTable.x, popupTable.y-(popupTable.initialButtonHeight+popupTable.height*(theElement-1)), popupTable.width, popupTable.height)						setColorOld(popupTable.color.text)
						love.graphics.print(popupTable.elements[theElement], popupTable.x+5,
